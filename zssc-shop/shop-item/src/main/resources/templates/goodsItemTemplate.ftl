    ...
    <div class="deta-info1">
        <div class="dt-if1-l f-l">
            <div class="dt-if1-datu">
                <ul qie-da="">
                    <#list pngList as png>
                        <li><a href="#"><img src="${png}" width="359" height="351"/></a></li>
                    </#list>
                    <div style="clear:both;"></div>
                </ul>
            </div>
            <div class="dt-if1-qietu">
                ...
                <div class="dt-qie-con f-l">
                    <ul qie-xiao="">
                            <#list pngList as png>
                                <#if png_index == 0>
                                        <li class="current"><a href="#"><img src="${png}" width="60" height="60" /></a></li>
                                <#else>
                                        <li ><a href="#"><img src="${png}" width="60" height="60" /></a></li>
                                </#if>
                            </#list>
                        <div style="clear:both;"></div>
                    </ul>
        ...
        <div class="dt-if1-m f-l">
            ...
            <div class="dt-ifm-gojia">
                <dl>
                    ...
                    <dd>
                        <p class="p1">
                            <span class="sp1">¥${gprice}</span><span class="sp2">29.50</span>
                        </p>
                        <p class="p2">
